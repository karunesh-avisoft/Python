...
class BankAccount:
    ...
    def __init__(self, acc_number=0, acc_holder="", balance=0):
        ...
        self.message(f'{self.__account_holder_name}, your account opened with initial balance ₹{self.__balance:.2f}','ACK')
    ...
    def deposit(self,amount):       # deposit amount
        if amount<=0:
            ...
            self.message(f'Amount ₹{amount:.2f} deposited to your account!','ACK')
            self.check_balance()
